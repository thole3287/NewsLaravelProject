    ...
    <div class="container">
        ...
        @csrf
            <div class="form-group">
                ...
                <input type="text" class="form-control bg-danger text-white" name="id" placeholder="Nhập tên môn học" value="{{$mh[0]->id}}" readonly>
            </div>
            <div class="form-group">
                <label class="h6" >Tên môn học</label>
                <input type="text" class="form-control" name="tenmonhoc" placeholder="Nhập tên môn học" value="{{$mh[0]->tenmonhoc}}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="sotinchi"  placeholder="Nhập số tín chỉ" value="{{$mh[0]->sotinchi}}">
